...
| `/status` | *(aucun)* | Affiche le statut du jour : Perfect Day ou non, seuils, streak, or, niveau/XP, quêtes faites / skippées / restantes, No-Todos échoués, et Life Lore accomplis aujourd'hui. | `/status` |
